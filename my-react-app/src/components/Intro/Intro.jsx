    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          <span style={{ color: darkMode ? "white" : "" }}>Ace Your Interviews</span>
      ...
      <div className="i-right">
        ...
        >
          <FloatinDiv img={crown} text1="Mock" text2="Interviews" />
        </motion.div>
        ...
        >
          ...
          <FloatinDiv img={thumbup} text1="Get Hired" text2="Faster" />
        </motion.div>
